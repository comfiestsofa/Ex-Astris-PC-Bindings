...
| Bluestacks/MSI App Player | 5.22.160.1025 | 13 | 会因libhoudini的错误而当机。存在色彩阶调断裂的问题。 | 尚未支援 |
| Bluestacks/MSI App Player | 5.22.160.1025 | 11 | 游戏可以运作，但与MuMuPlayer相比，效能明显下降。存在色彩阶调断裂的问题。 | 尚未支援 |
| PlayCover |  |  | 还没试过。 | 尚未支援 |
