...
| Bluestacks/MSI App Player | 5.22.160.1025 | 13 | 會因libhoudini的錯誤而當機。存在色彩階調斷裂的問題。 | 尚未支援 |
| Bluestacks/MSI App Player | 5.22.160.1025 | 11 | 遊戲可以運作，但與MuMuPlayer相比，效能明顯下降。存在色彩階調斷裂的問題。 | 尚未支援 |
| PlayCover |  |  | 還沒試過。 | 尚未支援 |
